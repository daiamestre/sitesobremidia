    ...
    useEffect(() => {
        const runBoot = async () => {
            ...
            if (isOnline) {
                ...
                // WARN: Don't stop boot, just warn.
            }
            ...
            if (isOnline) {
                ...
                if (!error) {
                    ...
                    // Don't error out, just mark as 'warning' or proceed as offline
                    setSteps((s) => ({ ...s, database: "success" }));
            ...
            <div className="w-full max-w-md p-8 space-y-8">
                ...
                <div className="text-center space-y-4">
                    ...
                    {(steps.config === 'error' || steps.network === 'error' || steps.database === 'error' || steps.bridge === 'error') && (
                        <button
                            onClick={() => onComplete(false)} // Manual override forces non-native flow or just continues
