      ...
      <AlertDialog open={wizardAberto} onOpenChange={(open) => !open && !enviando && setWizardAberto(false)}>
        <AlertDialogContent className="max-w-lg">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              O convite oficial do Supabase Auth será enviado ao e-mail informado — o novo usuário define a própria senha.
            </AlertDialogDescription>
          </AlertDialogHeader>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  O convite (e-mail oficial do Supabase Auth) será enviado para definir a senha.
                </p>
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-3 py-2">
              <div className="rounded-lg border p-4 space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">E-mail oficial (definição de senha)</Badge>
                </div>
              </div>
              <p className="text-xs text-muted-foreground">
                Ao confirmar, o usuário será criado no Supabase Auth, registrado no tenant atual com auditoria e
            ...
            <div className="space-y-3 py-2">
              <div className="flex flex-col items-center text-center gap-3 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Convite enviado para <strong>{criadoEmail}</strong>. O usuário confirmará o e-mail e definirá a própria senha.
                  </p>
                </div>
              </div>
            </div>
              ...
              <>
                ...
                {etapa === 2 && (
                  <Button onClick={enviarCriacao} disabled={enviando}>
                    ...
                    {enviando ? 'Criando usuário...' : 'Criar usuário e enviar convite'}
                  </Button>
                )}
              </>
            )}
