      ...
      <div className="p-6 rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-2xl flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/30 ml-2">FASE 9.3 BI</Badge>
          </div>
          <p className="text-slate-300 text-xs">Cubo Financeiro, EBITDA, Fluxo e Margem de Contribuição</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
        <Card className="border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-xl rounded-2xl">
          <CardContent className="p-4 space-y-1">
            ...
            <strong className="text-xl font-bold text-emerald-400">42.0%</strong>
          </CardContent>
        </Card>
        ...
        <Card className="border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-xl rounded-2xl">
          <CardContent className="p-4 space-y-1">
            ...
            <strong className="text-xl font-bold text-blue-400">R$ 1.740.000,00</strong>
          </CardContent>
        </Card>

        <Card className="border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-xl rounded-2xl">
          <CardContent className="p-4 space-y-1">
            <span className="text-slate-400 block font-semibold">Inadimplência Projetada</span>
            <strong className="text-xl font-bold text-amber-400">1.2%</strong>
          </CardContent>
        </Card>
      </div>
    </div>
