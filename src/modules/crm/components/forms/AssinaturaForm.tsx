...
export function AssinaturaForm({ onBack, onNext }: FormStepProps) {
  return (
    <Card className="w-full border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-2xl rounded-2xl animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription className="text-slate-300 text-sm mt-0.5">
              Passo 7 de 8: Envio de link de assinatura eletrônica (Clicksign/DocuSign).
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="pt-6 space-y-6">
        <p className="text-sm text-slate-300">
          Módulo de envio de assinatura digital para o e-mail do representante legal do cliente.
        </p>
