...
export const WIDGET_TEMPLATES: WidgetTemplateDef[] = [
  ...
  { id: 'weather-futurista', tipo: 'weather', nome: 'Clima Futurista', descricao: 'Peça vibrante com máxima, mínima e previsão dos próximos dias.', suportaFundo: true, noPlayer: false },
  { id: 'clock-futurista', tipo: 'clock', nome: 'Relógio Futurista', descricao: 'Relógio com glow e gradiente da identidade SOBRE MÍDIA.', suportaFundo: true, noPlayer: false },
