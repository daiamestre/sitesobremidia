-- ============================================================================
-- MIGRATION: 20261009_fix_player_playlist_rpc_roles_and_contract.sql
-- BUG FIX: get_player_playlist_for_screen wasn't resolving RBAC due to
-- the removal of the public.cargos table. Replaced with public.roles.
-- Preserves Zero Trust, Tenant isolation, Device Binding, and the layout contract.
-- ============================================================================
...
BEGIN
    ...
    IF v_auth_uid IS NOT NULL THEN
        SELECT u.empresa_operadora_id, r.name AS cargo_nome INTO v_user_ctx
