-- ============================================================================
-- MIGRATION: 20261007_fix_playlist_rpc_is_active.sql
-- BUG FIX: get_player_playlist_for_screen não verificava is_active, 
-- causando download de mídias inúteis antes do Realtime bloquear a tela.
-- ============================================================================
...
BEGIN
    ...
    -- 2.5 Active Check (Bloqueio Imediato para telas desativadas)
