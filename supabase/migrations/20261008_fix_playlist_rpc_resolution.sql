-- ============================================================================
-- MIGRATION: 20261008_fix_playlist_rpc_resolution.sql
-- BUG FIX: get_player_playlist_for_screen wasn't returning the playlist's resolution
-- causing Android Players on portrait screens to ignore 16:9 landscape playlists.
-- ============================================================================
...
BEGIN
    ...
    IF v_auth_uid IS NOT NULL THEN
        SELECT u.empresa_operadora_id, c.nome AS cargo_nome INTO v_user_ctx
    ...
    -- 7. Return Payload (FIX: Added playlist_resolution mapped to resolution)
